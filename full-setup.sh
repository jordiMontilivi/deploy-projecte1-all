...
# --- 1. VALIDACIÓ DE PARÀMETRES ---
# ... (codi anterior de validació dev/prod i rols)
...
if [ "$ROL" == "all" ] || [ "$ROL" == "backend" ]; then
    ...
    # Instal·lem Composer globalment (el gestor de dependències de PHP)
...
EOF"
        ...
        # 2. Blindem el fitxer perquè només 'root' el pugui llegir (Ciberseguretat)
